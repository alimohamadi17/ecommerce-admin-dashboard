...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 tracking-wider",
        destructive:
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 tracking-wider",
        ...
        blue: " text-white bg-blue-500 hover:bg-blue-600 transition tracking-wider",
      },
      size: {
